    <div class="block p-6 w-3/4 sm:w-1/2 rounded-lg shadow-lg bg-white">
        ...
        <form action="/" method="POST">
            <div class="form-group mb-6">
                ...
                <input name="loginEmail" type="email" class="form-control block w-full px-3 py-1.5 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:bg-white focus:border-roseClair focus:ring-0" id="email" aria-describedby="emailHelp" placeholder="Email">
            </div>

            <div class="form-group mb-6">
                <label for="password" class="form-label inline-block mb-2 text-lg font-semibold">Mot de passe</label>
                <input name="loginPassword" type="password" class="form-control block w-full px-3 py-1.5 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:bg-white focus:border-roseClair focus:ring-0" id="password" placeholder="Mot de passe">
            </div>
