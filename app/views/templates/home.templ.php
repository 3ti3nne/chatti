<div class="flex justify-center max-w-sm md:max-h-3/4">
    <div class="rounded-lg shadow-lg bg-white min-w-3/4 flex-col">
        <div class="object-contain">
            <img id="catPhoto" class="rounded-t-lg h-72 w-80 md:w-96" src="" alt="" />
        </div>
        ...
        <div class="flex justify-around mb-5">
            ...
            <button type="button" class="likeBtn p-3 rounded-full border flex justify-center items-center" data-value="0">
 ...
 -->
            ...
            <button type="button" class="likeBtn p-3 rounded-full border flex justify-center items-center" data-value="1">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-14 h-14 md:w-20 md:h-20">
